...
uninstall_node_docker_images() {
    ...
    if [ -z "$images" ]; then
        colorized_echo yellow "ghcr.io/alirezanorouzzadeh9/pasarguardnode images not found"
        return 0
    fi

    colorized_echo yellow "Checking ghcr.io/alirezanorouzzadeh9/pasarguardnode images for removal..."
